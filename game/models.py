...
class Movie(models.Model):
    ...
    review_1 = models.TextField() #rn im assuming well hold reviews as texts
...
# the below signals ensure a Profile is create automatically whenever a User registers    
